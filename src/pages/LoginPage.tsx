    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8 font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h2 className="text-lg font-bold text-slate-700 max-w-xs mx-auto leading-snug">
            Build your verified student identity, skills and professional portfolio.
          </h2>
        </div>
        ...
        <div className="bg-white py-8 px-6 sm:px-10 border border-slate-200 shadow-xl rounded-3xl space-y-6">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-slate-200 hover:border-slate-300 rounded-2xl shadow-xs text-sm font-extrabold text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all select-none cursor-pointer active:scale-98"
            >
              {loading ? (
